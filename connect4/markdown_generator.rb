...
class MarkdownGenerator
  IMAGE_BASE_URL = 'https://raw.githubusercontent.com/Nomes77/Connect4/main/images'
  ISSUE_BASE_URL = 'https://github.com/Nomes77/Connect4/issues/new'
  ...
  def readme(metadata:, recent_moves:)
    ...
    markdown.concat <<~HTML
        ...
        Interested in how everything works? [Click here](https://github.com/Nomes77/Connect4/tree/main/connect4) to read up on what's happening behind the scenes.
